...
// Last update Mon May  3 17:41:58 2010 anthony1 corbacho
*/
...
Plane		AirbusConstructor::CreatePlane(Pieces *piece)
{
  Plane		plane(this->_PlaneName, this->_StartingId, piece);
